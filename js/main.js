! function(e) {
    ...
    e(window).on("scroll", function() {
        ...
        e(window).width() >= 768 ? (e('a[href="#"]').on("click", function(e) {
            e.preventDefault()
        }), e(".categories").addClass("menu"), e(".menu ul > li").on("mouseover", function(t) {
            e(this).find("ul:first").show(), e(this).find("> span a").addClass("active")
        }).on("mouseout", function(t) {
            e(this).find("ul:first").hide(), e(this).find("> span a").removeClass("active")
        }), e(".menu ul li li").on("mouseover", function(t) {
            e(this).has("ul").length && e(this).parent().addClass("expanded"), e(".menu ul:first", this).parent().find("> span a").addClass("active"), e(".menu ul:first", this).show()
        }).on("mouseout", function(t) {
            e(this).parent().removeClass("expanded"), e(".menu ul:first", this).parent().find("> span a").removeClass("active"), e(".menu ul:first", this).hide()
    ...
    }), e(".custom-select-form select").niceSelect(), e(".color").on("click", function() {
    ...
    }), new WOW().init(), e("#forgot").on("click", function() {
